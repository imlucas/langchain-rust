...
1. **Handle Errors Gracefully**: Always wrap tool calls in proper error handling
1. **Use Caching**: Consider caching frequently accessed pages
1. **Respect Rate Limits**: Don’t make excessive concurrent requests
1. **Choose the Right Language**: Use the appropriate language code for your use case
